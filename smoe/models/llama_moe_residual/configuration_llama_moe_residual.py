...
class LlamaMoEResidualConfig(PretrainedConfig):
    ...
    def __init__(
            ...
            num_selects=4,
            size_experts=None,
            size_residual=None,  # ---- different here ---- #
            residual_use_weighting=True,  # ---- different here ---- #
            #### -------- moe gate configs -------- ####
        ...
        self.size_residual = size_residual  # ---- different here ---- #
        self.residual_use_weighting = residual_use_weighting  # ---- different here ---- #

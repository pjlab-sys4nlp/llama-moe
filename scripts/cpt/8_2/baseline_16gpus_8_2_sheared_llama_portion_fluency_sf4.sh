...
#SBATCH --job-name=cpt-llama2_random_split_16gpus_8_2
#SBATCH --output=/mnt/petrelfs/dongdaize.d/workspace/llama-moe-train/runs/2_8/%x-%j.log
#SBATCH --error=/mnt/petrelfs/dongdaize.d/workspace/llama-moe-train/runs/2_8/%x-%j.log
...
source ~/anaconda3/bin/activate llama-moe-train

{
    ...
    base_dir="/mnt/petrelfs/dongdaize.d/workspace/llama-moe-train/runs/2_8" ###########################

...
#SBATCH --job-name=cpt-llama2_random_split_112gpus_16_2_scale_factor_8
#SBATCH --output=/mnt/petrelfs/share_data/quxiaoye/runs/llama2_random_split_112gpus_16_2/%x-%j.log
#SBATCH --error=/mnt/petrelfs/share_data/quxiaoye/runs/llama2_random_split_112gpus_16_2/%x-%j.log
...

{
    ...
    base_dir="/mnt/petrelfs/share_data/quxiaoye/runs/llama2_random_split_112gpus_16_2"

...
#SBATCH --job-name=cpt-llama2_random_scale4_112gpus
#SBATCH --output=/mnt/petrelfs/share_data/quxiaoye/runs/llama2_random_scale4_112gpus/%x-%j.log
#SBATCH --error=/mnt/petrelfs/share_data/quxiaoye/runs/llama2_random_scale4_112gpus/%x-%j.log
...

{
    ...
    comment="llama 2 7B, random split 4/16, per-device bsz 32, lr 2e-4, 112gpus"
    ...
    base_dir="/mnt/petrelfs/share_data/quxiaoye/runs/llama2_random_scale4_112gpus"

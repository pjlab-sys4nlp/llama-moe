...
split_file_path=${root_path}/moefication_results/split/${llama_size}-${num_experts}Expert-Split-${split_type}
hidden_features_path=${root_path}/moefication_results/features/${llama_size}-Hidden-Features
save_path=${root_path}/moefication_results/select/${split_type}

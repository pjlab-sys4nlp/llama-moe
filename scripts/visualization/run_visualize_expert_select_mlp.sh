...
proj_type=up_proj        #  up_proj  gate_proj
...
save_path=/mnt/petrelfs/dongdaize.d/workspace/train-moe/visualization/${split_type}-${select_type}/${llama_size}-${num_experts}Expert-Select-MLP-${proj_type}
